...
:e
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\NDIS\Parameters" /v ReceiveWorkerThreadPriority /f
...
:d
reg add "HKLM\SYSTEM\CurrentControlSet\Services\NDIS\Parameters" /v ReceiveWorkerThreadPriority /t REG_DWORD /d 8 /f
